...
class Stripe_official extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        register_shutdown_function(function () use ($errorFlags) {
            ...
            if ($error !== null && in_array($error['type'], $errorFlags)) {
    ...
    public function install()
    {
        ...
        try {
            if (!parent::install()) {
                ...
                StripeProcessLogger::logInfo('After install - ps_accounts_installer', 'stripe_official');
            }
    ...
    */
    ...
    public function hookDisplayHeader()
    {
        ...
        $jsVersion = md5($this->version . self::getPublishableKey());
        ...
        Media::addJsDef([
            ...
            'stripe_message' => [
                'processing' => $this->translationService->hasNewTranslationSystem()
                    ? $this->translationService->translate('Processing…')
                    : $this->l('Processing…'),
                'accept_cgv' => $this->translationService->hasNewTranslationSystem()
                    ? $this->translationService->translate('Please accept the CGV')
                    : $this->l('Please accept the CGV'),
                'redirecting' => $this->translationService->hasNewTranslationSystem()
            ...
            'stripe_log_js_error' => $this->context->link->getModuleLink(
                $this->name,
                'logJsError',
                [],
                true
