...
class Ybc_newsletter extends Module
{
    ...
    public function renderConfig()
    {
	 ...
	 {
		$rq_sql = 'SELECT CONVERT(n.`email`, CHAR CHARACTER SET utf8mb4) as email, c.firstname,c.lastname
			FROM `'._DB_PREFIX_.$this->tableName.'` n
            LEFT JOIN  `'._DB_PREFIX_.'customer` c ON n.email=c.email COLLATE utf8mb4_general_ci
			WHERE n.`active` = 1
            UNION 
            SELECT CONVERT(`email`, CHAR CHARACTER SET utf8mb4),`firstname`,`lastname`
