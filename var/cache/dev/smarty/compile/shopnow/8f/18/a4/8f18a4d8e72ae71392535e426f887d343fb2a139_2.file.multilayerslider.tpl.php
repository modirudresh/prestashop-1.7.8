...
/* Smarty version 3.1.48, created on 2025-07-09 19:09:19
  from '/var/www/html/prestashop1.7/themes/shopnow/modules/ets_multilayerslider/views/templates/hook/multilayerslider.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_686e7107828eb1_22195652',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8f18a4d8e72ae71392535e426f887d343fb2a139' => 
    array (
      0 => '/var/www/html/prestashop1.7/themes/shopnow/modules/ets_multilayerslider/views/templates/hook/multilayerslider.tpl',
      1 => 1752055347,
      2 => 'file',
    ),
  ),
...
function content_686e7107828eb1_22195652 (Smarty_Internal_Template $_smarty_tpl) {
if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'LayoutHome1' || (isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'LayoutHome2') {
echo '<script'; ?>
...
" style="<?php if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'LayoutHome1' || $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'LayoutHome2') {?>width: <?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['mls_width']->value), ENT_QUOTES, 'UTF-8');?>
px; height: <?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['mls_height']->value), ENT_QUOTES, 'UTF-8');?>
px; <?php } else { ?> width: 1170px; height: 600px;<?php }?> <?php if ($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BACKGROUND']) {?>background-color: <?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BACKGROUND'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
